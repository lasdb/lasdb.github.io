...
news:
  ...
  - title: 'LASDB Meeting posponed'
    date: '20/09/20'
    subtitle: ''
    body: 'Due to the uncertainties associated with the pandemic, we have made the decision to postpone the next LASDB Meeting to 2022. As planned, LASDB-2022 will be in Chile. We are now working on the organization of a virtual meeting for 2021. Information will be available soon'
    imageSm: '../img/news/Chile2022a-sm.jpg'
    imageBg: '../img/news/Chile2022a-bg.jpg'
    URL: ''
    
  - title: 'New representative for Argentina at LASDB Board'
    date: '30/10/20'
    subtitle: ''
    body: 'We welcome Gabriela Pagnussat (IIB-CONICET, Mar del Plata, Prov. Buenos Aires) as a new Argentinean representative at LASDB. Gabriela is replacing Guillermo Lanuza, and together with Pablo Strobl-Mazzula, will represent the country in the LASDB Board.'
    imageSm: '../img/news/Pagnussat-sm.jpg'
    imageBg: '../img/news/Pagnussat-bg.jpg'
...
Alvaro Glavic, Miguel Allende, Verónica Palma, friends and colleagues'
  ...
  - title: 'List of virtual talks, seminars, forums'
    ...
    <strong>World Wide Neuro &ndash; Neuroscience seminars online:</strong>&nbsp;<a href="https://www.worldwideneuro.com/" target="_blank">https://www.worldwideneuro.com/</a><br>
    ...
    <strong>Cell Migration Seminars:</strong>&nbsp;<a href="https://cellmigration.wixsite.com/seminars" target="_blank">https://cellmigration.wixsite.com/seminars</a>'
...
Please follow this link to the obituary published by the Facultad de Ciencias, PUCE.'
  ...
  - title: '2021 ISDB Congress'
    ...
    body: 'The next meeting of the International Society of Developmental Biologists will happen in less than two years from now in Algarve, Portugal, October 17-21, 2021. The congress will take place at a seaside resort, with excellent congress facilities allowing maximal interaction among participants and very affordable onsite accommodation for all. In addition to keynote talks, the venue is prepared to run 3 parallel symposia, and we expect to cover a large variety of topics in Developmental Biology.
More information will be available at the ISDB webpage.'
    imageSm: '../img/news/ISDB2021-sm.jpg'
    imageBg: '../img/news/ISDB2021-bg.jpg'
    URL: 'http://www.developmental-biology.org/news/2019-isdb-meeting-algarve/'
