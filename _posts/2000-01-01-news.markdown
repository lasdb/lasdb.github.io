...
We share here a letter by his colleagues in the Developmenal Biology lab in Chile.<br><br>
...
Verónica Palma, Alvaro Glavic, Miguel Allende, friends and colleagues'
  ...
  - title: 'Spanish Society for Developmental Biology Meeting'
    date: '08/09/20'
    subtitle: 'November 18-20, 2020. Virtual SEBD-2020'
    body: 'Abstract submission and Early registration is extended deadline until October 1st!. Standard registration: October 15th.'
  ...
  - title: 'List of virtual talks, seminars, forums'
    date: '05/08/20'
    subtitle: 'Developmental biology and adjacent. Posted by The Node and SFDB'
    body: 'Various organisations and looser assemblies of locked down researchers have begun to put together online seminar and talk series, many of which are open to anyone (usually with registration), and many of which also have previous talks recorded. <br>
    <a href="https://sfbd.fr/en/online-events/" target="_blank">Link SFDB events</a> <br>
    <a href="https://thenode.biologists.com/list-of-virtual-talks-seminars-forums/events/" target="_blank">Link The Node post</a>'
