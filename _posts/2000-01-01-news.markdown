...
news:
  ...
  - title: 'List of virtual talks, seminars, forums'
    date: '05/08/20'
    subtitle: 'Developmental biology and adjacent. Posted by The Node '
    body: 'Various organisations and looser assemblies of locked down researchers have begun to put together online seminar and talk series, many of which are open to anyone (usually with registration), and many of which also have previous talks recorded.'
   ...
   - title: 'IJDB, Latin America Dev Biol issue'
    date: '12/08/20'
    subtitle: 'online'
    body: 'The Latin American Society for Developmental Biology:
A Successful History20 years of the Practical Course of Developmental Biology in Latin America:
From Santiago to Quintay, via Juquehy, Buenos Aires and Montevideo.
    http://www.ijdb.ehu.es/web/paper/200019mz/the-latin-american-society-for-developmental-biology-a-successful-history
    http://www.ijdb.ehu.es/web/paper/200049rm/20-years-of-the-practical-course-of-developmental-biology-in-latin-america-from-santiago-to-quintay-via-juquehy-buenos-aires-and-montevideo'
