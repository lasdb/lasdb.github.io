...
Application deadline: April 10th, 2026'
    ...
    par2: 'Requirements: doctorate in Biological Sciences or related areas; training in cellular and molecular biology applied to invertebrate immunology; experience with microscopy and experimental design. The ability to conduct an independent project, work in international collaboration and co-supervise students is expected. Excellent communication skills in English (spoken and written). Proficiency in Portuguese and/or Spanish, as well as experience with ascidian research is desirable. We welcome applicants from all backgrounds, and particularly encourage women and those from underrepresented groups to apply. For more info, or to apply please send letter of interest, CV, and contact details of up to 3 referees to Federico D. Brown (fdbrown@usp.br).'
    URL: ''
